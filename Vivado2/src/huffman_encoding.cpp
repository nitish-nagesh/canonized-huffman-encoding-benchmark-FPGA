...
void huffman_encoding(
    ...
    PRAGMA_HLS(HLS array_partition variable=sorted factor=copy1 cyclic)
    PRAGMA_HLS(HLS array_partition variable=sorted_copy1 factor=copy1 cyclic)
    PRAGMA_HLS(HLS array_partition variable=sorted_copy2 factor=copy1 cyclic)
    PRAGMA_HLS(HLS array_partition variable=parent factor=createtree_partition cyclic)
    PRAGMA_HLS(HLS array_partition variable=left factor=createtree_partition cyclic)
    PRAGMA_HLS(HLS array_partition variable=right factor=createtree_partition cyclic)
	...
	PRAGMA_HLS(HLS array_partition variable=encoding factor=assigncodeword_partition cyclic)
